...
const Features = () => {
    const features = [
        ...
        },
        {
            ...
            description: 'Enterprise-grade security features built-in to protect your applications.',
            icon: (
        ...
        {
            title: 'Modern Stack',
            description: 'Built with the latest technologies including React 19, TypeScript, and Tailwind.',
            icon: (
            ...
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto">
                        Everything you need to build professional applications in record time.
                    </p>
                </div>
